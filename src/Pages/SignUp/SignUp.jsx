  ...
  return (
    <>
      <div className="flex h-screen ">
        {/* Left Pane */}
        <div className="hidden lg:flex items-center justify-center flex-1 bg-emerald-100 text-black">
        ...
        {/* Right Pane */}
        <div className="w-full bg-emerald-100 lg:w-1/2 flex items-center justify-center">
          <div className="max-w-md w-full p-6">
            ...
            <form action="#" method="POST" className="space-y-4">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-emerald-500 text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
                >
                  Sign Up
                </button>
              </div>
